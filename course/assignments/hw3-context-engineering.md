...
### 3. Test Context (25%)
- Add a feature **WITHOUT** rules active
- Add the same feature **WITH** rules active
...
### Comparison (10 pts)
- Clear methodology: 4 pts
- Measurable improvement: 6 pts

### Documentation (6 pts)
- Report quality: 4 pts
- Best practices guide: 2 pts
