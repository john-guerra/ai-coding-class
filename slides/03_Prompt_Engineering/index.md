...
**Part 1: User Research Workshop**

1. Mom Test Principles
...
**This is why we have the No-AI Challenge.**
...
1. **Mom Test:** Ask about past behavior, not future promises
2. **Design Thinking:** Empathize → Define → Ideate → Prototype → Test
3. **Good prompts:** Context + Task + Format + Constraints + Examples
4. **Patterns:** Few-shot, chain-of-thought, role prompting, structured output
5. **Iterate:** Expect 2-5 rounds for complex prompts
6. **Verify:** AI output needs human validation
...
- [Anthropic Docs: Prompt Library](https://docs.anthropic.com/en/resources/prompt-library/library)
